...
namespace MVCAspNetApp.Controllers
{
    public class QuizUserAnswersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["QuizQuestionOption_id"] = new SelectList(_context.QuizQuestionOptions, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,QuizQuestionId,QuizQuestionOption_id")] QuizUserAnswer quizUserAnswer)
        {
            ...
            ViewData["QuizQuestionOption_id"] = new SelectList(_context.QuizQuestionOptions, "Id", "Id", quizUserAnswer.QuizQuestionOption_id);
            return View(quizUserAnswer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuizQuestionId,QuizQuestionOption_id")] QuizUserAnswer quizUserAnswer)
        {
