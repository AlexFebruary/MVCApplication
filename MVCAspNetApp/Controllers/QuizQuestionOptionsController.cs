...
namespace MVCAspNetApp.Controllers
{
    public class QuizQuestionOptionsController : Controller
    {
        ...
        {
            ViewData["QuizQuestion_Id"] = new SelectList(_context.QuizQuestions, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,QuizQuestion_Id,text,is_correct")] QuizQuestionOption quizQuestionOption)
        {
            ...
            ViewData["QuizQuestion_Id"] = new SelectList(_context.QuizQuestions, "Id", "Id", quizQuestionOption.QuizQuestion_Id);
            return View(quizQuestionOption);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,QuizQuestion_Id,text,is_correct")] QuizQuestionOption quizQuestionOption)
        {
